...
class TestPhoneCalculation(unittest.TestCase):
    def test_compute_minute_types(self):
        # Test case 1: Call starts and ends during the day
        ...
        # Test case 2: Call starts during the night and ends during the day
        ...
        # Test case 3: Call starts and ends during the night
